...
/*以下是菜单调参*/
float Gyro_Kp = -0.85, Gyro_Ki = -0.5;
float Vertical_Kp = -3.1, Vertical_Kd = -0.1; // 直立环
int Target_Speed = 130;
float Velocity_Kp = -20, Velocity_Ki = -0;					   // 速度环
float Turn_kp1 = 3.0, Turn_kp2 = 0.89, Turn_kd1, Turn_kd2 = -0.7; // ppdd转向环
/*===============================================================*/
uint32 pid_count = 0;
uint8_t stop;
